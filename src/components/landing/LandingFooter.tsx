  ...
  return (
    <footer className="border-b pt-20">
      <div className="mb-8 border-b md:mb-12">
        <div className="mx-auto flex max-w-full flex-wrap items-end justify-between gap-6 px-4 pb-6 lg:px-8 xl:px-12 2xl:px-16">
          <Link
            href="/"
            aria-label="go home"
      ...
      <div className="mx-auto max-w-full px-4 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div className="mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6">
          <small className="order-last block text-center text-sm text-muted-foreground md:order-first">
            © {new Date().getFullYear()} View Market, All rights reserved
          </small>
          <form action="">
